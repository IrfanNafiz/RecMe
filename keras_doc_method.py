...
# remove desktop.ini file from class_names
...
mdlcheckpoint_cb = keras.callbacks.ModelCheckpoint(model_save_filename, verbose=1,  monitor="val_accuracy", save_best_only=True
)
